...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('kind', models.CharField(choices=[('F', 'Fall'), ('S', 'Spring'), ('s', 'Summer')], max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('semester_kind', models.CharField(choices=[('F', 'Fall'), ('S', 'Spring'), ('s', 'Summer')], max_length=1)),
                ...
                ('admin', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='courses', to='main.admin')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='classroom',
            name='semester',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='main.semester'),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='faculty',
            name='head',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='head_of_faculty', to='main.professor'),
        ),
        migrations.AddField(
            model_name='college',
            name='chairman',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='dean_of_college', to='main.professor'),
        ),
        migrations.AddField(
            model_name='classroom',
            name='instructor',
        ...
        migrations.AddField(
            model_name='classroom',
            name='students',
            field=models.ManyToManyField(through='main.Enrollment', to='main.student'),
        ),
        migrations.CreateModel(
            name='AssignmentSubmission',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('submitted_file', models.FileField(blank=True, null=True, upload_to='')),
        ...
        migrations.AddField(
            model_name='assignment',
            name='submissions',
            field=models.ManyToManyField(related_name='submissions', through='main.AssignmentSubmission', to='main.student'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('material_type', models.CharField(choices=[('l', 'Lab'), ('L', 'Lecture'), ('t', 'Tutorial'), ('a', 'Assignment'), ('s', 'Problem Sheet'), ('o', 'Other')], default='o', max_length=1)),

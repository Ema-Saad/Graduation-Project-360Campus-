<template>
  <div :class="{'blur': showPopup}" class="user-profile">
    ...
    <div class="right-section">
      ...
      <!-- Tabs -->
      <div class="tabs">
        <router-link to="/doctor-profile" class="tab" active-class="active">
          <i class="fas fa-user"></i> About
        </router-link>
        <router-link to="/doctor-timeline" class="tab" active-class="active">
          <i class="fas fa-clock"></i> Timeline
          <span v-if="taskCount > 0" class="task-count">{{ taskCount }}</span>
        </router-link>
        <router-link to="/doctor-settings" class="tab" active-class="active">

  ...
  <div class="user-profile">
    ...
    <div class="left-section">
      ...
      <div class="profile-image-container">
        <img src="@/assets/doctorpic.png" alt="User Image" class="profile-image" />
    ...
    <div class="right-section">
      ...
      <!-- Tabs -->
      <div class="tabs">
        <router-link to="/doctor-profile" class="tab" :class="{ active: $route.path === '/doctor-profile' }">
          <i class="fas fa-user"></i> About
        </router-link>
        <router-link to="/doctor-timeline" class="tab" :class="{ active: $route.path === '/doctor-timeline' }">
          <i class="fas fa-clock"></i> Timeline
          <span v-if="taskCount > 0" class="task-count">{{ taskCount }}</span>
        </router-link>
        <router-link to="/doctor-settings" class="tab" :class="{ active: $route.path === '/doctor-settings' }">

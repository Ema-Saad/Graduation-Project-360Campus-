  ...
  <div class="profile-container">
    ...
    <div class="profile-left">
      ...
      <div class="profile-image-wrapper">
        <img src="@/assets/doctorpic.png" alt="User Image" class="profile-photo" />
    ...
    <div class="profile-right">
      ...
      <div class="profile-tabs">
        <router-link to="/doctor-profile" class="profile-tab" :class="{ active: $route.path === '/doctor-profile' }">
          <i class="fas fa-user"></i> About
        </router-link>
        <router-link to="/doctor-timeline" class="profile-tab" active-class="active">
          <i class="fas fa-clock"></i> Timeline
          <span v-if="taskCalc > 0" class="task-calc">{{ taskCalc }}</span>
        </router-link>
        <router-link to="/doctor-settings" class="profile-tab" :class="{ active: $route.path === '/doctor-settings' }">
    ...
    <div v-if="showPopup" class="popup-overlay">
      <div class="popup-content">
        ...
        <div class="profile-pic-container">
          ...
          <img src="@/assets/doctorpic.png" alt="Profile Picture" class="profile-pic" />
